...
def process_knowledge_graph(data_path='dataset/UserBehavior.csv'):
    ...
    with open(data_path, 'r') as f:
        ...
        #relation_index = 0
        for row in reader:
            user_id, item_id, category_id, action_id, timestamp = row
           ...
           # timestamp = int(infos[4])
            ...
            if action_id not in relations_dict:
                ...
                #relation_index += 1
                relations_dict[action_id] = len(relations_dict)
    ...
    print ('5015377'in entities_dict.keys())
